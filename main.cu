...
#include "impls/gpu_fix_impl.cuh"
...
int main(int argc, char *argv[]){
    ...
    start = chrono::high_resolution_clock::now();
    size_t n_sol_gpu_fix = pne_gpu_fix(C, u, n);
    end = chrono::high_resolution_clock::now();
    chrono::duration<double, milli> elapsed_gpu_fix = end - start;
    ...
    cout << "Extra implementation" << endl;
    cout << "Number of solutions (GPU) fix poin t= " << n_sol_gpu_fix << endl;
    cout << "Time (GPU) fix = " << elapsed_gpu_fix.count() << " ms" << endl;
